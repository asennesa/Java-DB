...
SELECT first_name, last_name, job_title AS 'JobTitle ' FROM employees WHERE salary BETWEEN 20000 AND 30000;
...
SELECT * FROM employees ORDER BY salary DESC, first_name ASC ,last_name DESC, middle_name ASC ,employee_id ASC;
...
SELECT DISTINCT job_title as Job_title FROM employees ORDER BY job_title ASC;

/*---18. Find First 10 Started Projects ---*/
SELECT * FROM projects ORDER BY start_date asc,name LIMIT 10;
